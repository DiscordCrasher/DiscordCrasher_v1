...
public class Flooder {
    ...
    public Flooder(Label errorLabel, Label messageCountLabel, TextField emailTextField, PasswordField passwordTextField, TextField idTextField, Button startButton, Button cancelButton, CheckBox embededCheckBox, Spinner<Integer> delaySpinner) {
    ...
    public void attack(String token, String channel_id) throws IOException, InterruptedException {
        ...
        if (embededCheckBox.isSelected()) {
            ...
            embed.put("title", random.nextInt());
            embed.put("description", payload);
